...
ACCESS_KEY = '75f884fbdaff9c3deab8f324682524fd' # get free at https://ipstack.com/product
...
class Weather(Frame):
    ...
    def get_weather(self):
        ...
        self.after(600000, self.get_weather) #reset after 600000 miliseconds or 10 minutes
...
class MCalendar(Frame):
    ...
    def get_events(self):
        ...
        try:
            ...
            for event in events:  #get events in coming week
                if (event.begin>= now) and (event.begin <= then):
                    listOfEvents.append(event)
            
            listOfEvents.sort(key=lambda x: x.begin) #sort after date

            for event in listOfEvents[0:5]: #get next 5 events
